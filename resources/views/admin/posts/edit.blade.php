    ...
    <div class="col-lg-12">
        <form role="form" action="/admin/posts/{{$post->id}}" method="POST">
            ...
            <div class="form-group">
                ...
                <input class="form-control" placeholder="請輸入文章標題" name="title" value="{{old('title,$post->title')}}">
            </div>

            <div class="form-group">
                <label for="content">內容：</label>
                <textarea class="form-control" rows="10" id="content" value="{{old('content',$post->content)}}"></textarea>
            </div>
